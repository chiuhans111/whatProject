...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__gravity__ = __webpack_require__(5);
...
var appdata = {
    play: true,
    preview: true,
    setup: __WEBPACK_IMPORTED_MODULE_2__gravity__["a" /* default */].setup
}
...
function update(forceUpdate) {
    ...
    if (appdata.play) {
        t++;
        stop = false;
        if (!forceUpdate) __WEBPACK_IMPORTED_MODULE_2__gravity__["a" /* default */].simulate(__WEBPACK_IMPORTED_MODULE_2__gravity__["a" /* default */].planets);
    }
    ...
    if (true) {
        ...
        for (var i of __WEBPACK_IMPORTED_MODULE_2__gravity__["a" /* default */].planets) {
            ctx.beginPath();
...
__webpack_require__(0);
(function webpackMissingModule() { throw new Error("Cannot find module \"./m.js\""); }());
